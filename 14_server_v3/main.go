...
// Adaptations made by me to complete exercise and return a lissajous gif on the /gif endpoint
// combined webserver that returns request info on / and generates a lissajous gif on /gif
